...
\begin{figure*}
\centering 
\subfloat[]{\label{fig:sep11-temp}\includegraphics[width=0.5\textwidth]{figs/sep11-ww-temp.png}} 
\subfloat[]{\label{fig:sep11-sal}\includegraphics[width=0.5\textwidth]{figs/sep11-ww-salinity.png}}\\
\subfloat[]{\label{fig:sep11-flh}\includegraphics[width=0.5\textwidth]{figs/sep11-ww-flh.png}} 
\subfloat[]{\label{fig:sep11-n2}\includegraphics[width=0.5\textwidth]{figs/sep11-ww-n2.png}} 
\caption{\small }
