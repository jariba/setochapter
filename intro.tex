...
AI based planning and %\sout{probabilistic} 
state estimation in a hybrid executive\cite{mcgann08a,mcgann08b,py10}. 
%  \sout{Probabilistic state estimation integrates a number of science observations to produce a
% likelihood that the vehicle sensors perceive a feature of
% interest}.\fcomment{\rx {\em does not} integrate probabilistic state
%   estimation! ... The HMM estimation was coded on top of \eu model but
%   neither \eu or \rx had explicit management of it} 
...
state estimation.
% \sout{the probability of having detected such a phenomenon} 
...
estimation on top of this framework \cite{mcgann08d}, such aspect is
out of scope of this chapter.
% Probabilistic state estimation through modeling within 
% this framework can be done is discussed elsewhere
% \cite{mcgann08d} and out of scope for this chapter. 
