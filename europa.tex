...
%\kcomment{This para could do with a little
  embellishment especially since it is the only material that actually
  talks about the kinds of constraints and their origin.JB: I don't really know what else to say given the table above.}
