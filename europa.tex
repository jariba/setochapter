...
\comment{I think we should expand on this section which, as the
  reviewer notes, the inter-relationships between the elements in Fig
  \ref{fig:europa-architecture} below is not fully captured. I think
  an illustrative example of how these components work together might
  be very useful. This might also help the sub-section end less
  abruptly than it is currently.}
...
Before diving into the details of each module, a simple example illustrates how they interact at a high level:
...
polynomial time \comment{definition needed?}, \eu takes advantage of
