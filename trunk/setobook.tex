...
\abstract{We describe a general purpose Artificial Intelligence based
  ...
  (\rxe) framework deliberates about future states, plans for actions
  ...
  observation. \rx is in \kcomment{regular} operational use at MBARI,
...
at NASA Ames \kcomment{who not only made \eu available as open source
  but encouraged its use outside the agency}. Minh Bin Do (NASA Ames),
...
are indebted to Nicola Muscettola \kcomment{(Google)} for his ideas
