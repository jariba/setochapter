...
\begin{figure*}
  \centering
  \subfloat[A conceptual view of the \od]{\label{fig:odss-concept}\includegraphics[width=0.5\textwidth]{figs/odss-concept.pdf}}\\
  \subfloat[Current Implementation for
...
\caption{\small \ref{fig:odss-mtg} shows a 2010 \can meeting with the
  ...
  deployments. \ref{fig:odss-ipad} shows \od use on a portable iPad
  device.}
\label{fig:odss2}
\end{figure*}
