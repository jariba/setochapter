...
\begin{figure*}
\centering
\subfloat[]{\label{fig:sep10-ship}\includegraphics[width=0.44\textwidth]{figs/sep10-canon-cruise.png}}
...
tracked by the \od. \kcomment{To date}, the \od has provided a simple
