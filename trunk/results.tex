...
\begin{figure*}
\centering
\subfloat[The ODSS Concept]{\label{fig:odss-concept}\includegraphics[width=0.5\textwidth]{figs/odss-concept.pdf}}\\
\subfloat[Current Implementation for \texttt{CANON}]{\label{fig:odss-frontend}\includegraphics[width=0.5\textwidth]{figs/dss-screenshot.png}}
\caption{\small The Oceanographic Decision Support System (ODSS) is a
  ...
  field experiments. The ODSS has been used since mid-year 2010 for
  \texttt{CANON} field experiments.}
\label{fig:odss}
\end{figure*}
...
\texttt{CANON} target. However, their retargeting was carefully
...
\caption{\small Fig. \ref{fig:odss-mtg} shows a 2010 \can meeting with the
  ODSS in use while Fig. \ref{fig:odss-ipad} shows its use on a portable
  device.}
xf\label{fig:odss2}
\end{figure*}
...
Additionally, our work on ODSS is driven by a vision of how marine
...
making, onshore as well as on-board. We believe ultimately ODSS will
...
learning techniques used in recommender
systems\cite{Adomavicius05}. Adaptive sampling strategies will then
balance decision-making \situ with that done onshore with
computational models and human agents, the subject of a new NSF
project in which the authors are participating.


Operationally, the ODSS has become a software system that the
...
locations. In the near future, the ODSS will consult its situational
...
being tracked by the ODSS. Thus far, the ODSS has provided a simple
