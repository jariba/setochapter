...
\cite{mcgann08b}. Not only was deliberation aided by direct perception
of the state (of the INL) but temporal transition functions added a
...
planner is novel in the ocean sciences and is a continuing direction
of investigation \cite{kumar11}.
...
our model \kcomment{supports} multiples patterns (square, lawn-mower,
...
point generated by a drifter. \kcomment{A drifter tracking application
  ...
  enclosure to provide oceanographic context to the drifting body.}
...
\begin{figure*}
\centering
\subfloat[]{\label{fig:sep10-ship}\includegraphics[width=0.4\textwidth]{figs/sep10-canon-cruise.png}}
\subfloat[]{\label{fig:sep10-transects}\includegraphics[width=0.40\textwidth]{figs/september-iterations.pdf}}
...
These theoretic\kcomment{al} results were validated in a five-day long
...
\begin{figure*}
  ...
  field experiments]{\label{fig:odss-concept}\includegraphics[width=0.5\textwidth]{figs/odss-concept.pdf}}\\
  \subfloat[Current implementation of \od for
  \can]{\label{fig:odss-frontend}\includegraphics[width=0.5\textwidth]{figs/dss-screenshot.png}}
...
\begin{figure*}
\centering
\subfloat[]{\label{fig:odss-mtg}\includegraphics[width=0.325\textwidth]{figs/october-canon-meeting.png}}
\subfloat[]{\label{fig:odss-virtual}\includegraphics[width=0.37\textwidth]{figs/virtual-drifter-tool.png}}
\subfloat[]{\label{fig:odss-ipad}\includegraphics[width=0.325\textwidth]{figs/photo-ipad-2.jpg}}
...
into the space-time region of interest to generate candidate
