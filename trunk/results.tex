...
\kcomment{The Dorado uses two onboard computers: a main vehicle computer which
is a 244 Mhz PC/104 stack running the QNX real-time operating system,
and a 367 MHz EPIC EPX-GX500 AMD Geode stack running Linux and \rxe. A
socket-based communication protocol allows the exchange of goals and
state updates between \rx and the lower level functional layer.}
...
sciences and is a continuing direction of investigation
\cite{kumar11}.
