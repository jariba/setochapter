...
\item[\textbf{Token State Model}] In \eu's representation, goals are
  ...
  \begin{figure}[t]
    \centering \subfloat[\small Timelines representing initial state
    and goals for a Shopping
    Agent.]{\label{fig:europapr1}\includegraphics[scale=0.35]{figs/europa-pr-1.pdf}}\qquad
    \subfloat[\small State of timelines after satisfying a goal to be
    home by time $20$ on merging with initial
    state.]{\label{fig:europapr:merge}\includegraphics[scale=0.35]{figs/europa-pr-merge.pdf}}\qquad
