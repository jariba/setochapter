...
\comment{Add figure showing the effect of merging; all figs on this
  section are conjoined. JB to sketch it out.}
...
\comment{Add figure showing possible state transitions. Need a FSM.}
