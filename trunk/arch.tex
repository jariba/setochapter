...
critical failure of the reactor. It will only result on these goals
being ignored until newer goals are received.
...
\begin{figure}[b]
  ...
  \caption{\small Impact of the \texttt{Sampling} reactor failure in
    the AUV agent shown in Fig. \ref{fig:agent}}
\end{figure}
