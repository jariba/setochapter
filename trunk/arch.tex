...
internal state of the plan gets out of synch with the actual state of
the world.
...
\item {\em Observation on current state values}: This information
  ...
  advances. \kcomment{Observations can therefore be both sensor
    measurements as well state passed up from other reactors. The
    strict rules of timeline ownership enable a clear policy for
    conflict resolution: observations dominate expectations.}
