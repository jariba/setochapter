...
\begin{figure}[b]
  ...
  \texttt{Failed} observation.]{\includegraphics[width=0.35\columnwidth]{figs/AUV-fail0.pdf}
  \label{fig:fail0}}
  \qquad
...
\begin{figure}[!b]
  ...
  observation was received by the reactor with the plan showed in
    Fig. \ref{fig:shop:exec0}.]{\label{fig:shop:exec1}\includegraphics[width=.7\columnwidth]{figs/shoping_exec_t1}}
