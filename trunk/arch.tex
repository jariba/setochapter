...
\item \texttt{step} that accepts new goals requested (if any) on the
  ...
  deliberation. In the context of Europa for example pone step of
  ...
  these. \comment{By extending I may have saud things I developped
    below ... will have  to check}
\end{itemize}
...
\comment{how? Is there a terminating condition? No more flaws but I
  washoping it would have been defined in europa section} its {\em external}
...
In the europa based reactor we introduce this decision reuqirement 
as a new type of flaw for the europa framework. This flaw enforces at the
