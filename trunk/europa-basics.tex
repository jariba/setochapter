...
mutual exclusion and concurrency using propositions \comment{citation
  needed}. 
Constraint Programming is a framework that lends itself very well to represent and reason about all of those elements \comment{Ixtet citation?},
...
where action choices and relationships are represented as variables and/or constraints \comment {citations 158,519,539,556 from malik's book}.
