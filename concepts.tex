...
\comment{Too abrupt; needs a narrative here. It comes across as a list
of items (given all the enumerates) and needs some prose. Also the
material should be expository not in a conversational style.}
