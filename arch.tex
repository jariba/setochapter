...
T-REX architecture is structured around the notion of 
...
This reactor is implemented following the idea that in T-REX, the
...
This choice is directed not only by some natural heurisitc
...
By our design choices -- both at the architecture level and the integration of
