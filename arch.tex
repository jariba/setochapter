...
\comment{this might be a subsubsection before someplace since it
  introduces the concept of latency/lookahead. TODO: yep it needs to
  move up to the architecture section.}
...
\begin{figure}[!htbp]
  ...
  \caption{The planning window of the deliberation solver and its
    relation with the reactor latency and look-ahead. The dark grey tokens
    with dashed borders are excluded from deliberation as they do not
    overlap the interval $[\tau, \tau+\lambda+\pi]$}
