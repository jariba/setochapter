...
\kcomment{algorithmically} complete. Take for example this rule from
...
decisions on flaws that are beyond this scope \comment{::is this last
  sentence correct?}. As time advances, these potential future flaws
...
\kcomment{\cite{myers99}} of the reactor. When there are no more flaws
