...
solver do not identify any more flaw to be resolved in the plan.
 ...
 When such plan is identified, its {\em external}
...
Finally, when the deliberation process did identify a complete
...
is complete.% \comment{I may need more examples/refs here}. 
...
\end{quotation}
\comment{fpy: This is my interpretation of this sentence at least .... feel
  free to comment in case you disagree}
